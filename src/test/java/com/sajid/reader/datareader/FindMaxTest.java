...
public class FindMaxTest {
	...
	@Test
	@DisplayName("Find Max SP_O2 >> 200")
	void test1() {
		...
		ResponseEntity<Object> responseEntity = restTemplate.exchange("/v1/iotdata/max/device-A?from=2022-05-15 11:10:00&to=2022-05-15 11:16:00&healthAttribute=SPO2", HttpMethod.GET, null, Object.class);
		Integer maxSpO2 = (Integer) responseEntity.getBody();
		assertNotNull(responseEntity.getBody());
		assertThat(responseEntity.getStatusCode()).isEqualTo(HttpStatus.OK);
		assertEquals(maxSpO2, 87);
	}

	@Test
	@DisplayName("Find Max BP >> 200")
	void test2() {
		...
		ResponseEntity<Object> responseEntity = restTemplate.exchange("/v1/iotdata/max/device-A?from=2022-05-15 11:10:00&to=2022-05-15 11:16:00&healthAttribute=BLOOD_PRESSURE", HttpMethod.GET, null, Object.class);
		Integer maxSpO2 = (Integer) responseEntity.getBody();
		assertNotNull(responseEntity.getBody());
		assertThat(responseEntity.getStatusCode()).isEqualTo(HttpStatus.OK);
		assertEquals(maxSpO2, 146);
	}

	@Test
	@DisplayName("Find Max PULSE RATE >> 200")
	void test3() {
		jdbcTemplate.execute("Insert into IOT_DATA(ID_DEVICE, EVENT_TIME, PROCESSED_TIME, SP_O2, BLOOD_PRESSURE, PULSE_RATE) values ('device-A', {ts '2022-05-15 11:11:11'}, {ts '2022-05-15 11:11:11'}, 80, 132, 78)");
		jdbcTemplate.execute("Insert into IOT_DATA(ID_DEVICE, EVENT_TIME, PROCESSED_TIME, SP_O2, BLOOD_PRESSURE, PULSE_RATE) values ('device-A', {ts '2022-05-15 11:11:12'}, {ts '2022-05-15 11:11:11'}, 87, 146, 80)");
		ResponseEntity<Object> responseEntity = restTemplate.exchange("/v1/iotdata/max/device-A?from=2022-05-15 11:10:00&to=2022-05-15 11:16:00&healthAttribute=PULSE", HttpMethod.GET, null, Object.class);
		Integer maxSpO2 = (Integer) responseEntity.getBody();
		assertNotNull(responseEntity.getBody());
		assertThat(responseEntity.getStatusCode()).isEqualTo(HttpStatus.OK);
		assertEquals(maxSpO2, 80);
	}
	...
	void test5() {
		ResponseEntity<Object> responseEntity = restTemplate.exchange("/v1/iotdata/max/device-A?from=2022-05-15 11:10:00&to=2022-05-15 13:16:00&healthAttribute=PULSE", HttpMethod.GET, null, Object.class);
		assertNotNull(responseEntity.getBody());
	...
	void test6() {
		ResponseEntity<Object> responseEntity = restTemplate.exchange("/v1/iotdata/max/device-A?from=2022-05-16 11:10:00&to=2022-05-15 13:16:00&healthAttribute=PULSE", HttpMethod.GET, null, Object.class);
		assertNotNull(responseEntity.getBody());
		LinkedHashMap errorInfo = (LinkedHashMap) responseEntity.getBody();
